            ...
            <div className="w-full flex justify-center items-center">
                {
                    user && <>
                        <Link to={"/add-blog"}>
                            <button className="text-xs font-bold bg-blue-600 hover:bg-blue-700 active:bg-blue-800 px-2 py-1 rounded-md text-white">Write a blog</button>
                        </Link>
                    </>
                }
            </div>
            <div>
                {
                    value.map(item => <div key={item._id}>
                        <h1 className="font-semibold text-xl  border-b-2 pb-1 flex items-center gap-1  justify-between">
                            <span className="flex justify-center items-center gap-1"><FaBlogger></FaBlogger>{item.userName}</span><span>{item.userEmail}</span>
                        </h1>
